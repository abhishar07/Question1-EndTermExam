...
public class Question1 {
	public static void main(String[] args){
		...
		case 1:
		{
			String dept = "ECE";//this case is or ECE
			ECE obj1 = new ECE();//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			System.out.println(obj1.displayCourseDetails(dept));//call the function of the class that you initialized
			break;
		}
		case 2:
		{
			String dept = "Mechanical";//this case is or Mechanical
			...
			System.out.println(obj2.displayCourseDetails(dept));//call the function of the class that you initialized
			break;
		}
		case 3:
		{
			String dept = "CSE";//this case is or CSE
			CSE obj3 = new CSE();//Initialize the Class using appropriately taking the concept of inheritence and polymorphism in mind.
			System.out.println(obj3.displayCourseDetails(dept));//call the function of the class that you initialized
			break;
		}
		default:
